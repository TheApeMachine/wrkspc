...
require (
	...
	github.com/minio/madmin-go v1.4.27 // indirect
	github.com/minio/md5-simd v1.1.2 // indirect
	github.com/minio/pkg v1.3.2 // indirect
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.59.0 // indirect
